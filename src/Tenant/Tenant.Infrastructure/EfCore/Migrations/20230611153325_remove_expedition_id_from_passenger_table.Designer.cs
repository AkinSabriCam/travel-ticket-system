...
namespace Tenant.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20230611153325_remove_expedition_id_from_passenger_table")]
    partial class remove_expedition_id_from_passenger_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tenant.Domain.Ticket.Ticket", b =>
                {
                    ...
                    b.HasOne("Tenant.Domain.Passenger.Passenger", "Passenger")
                        .WithMany("Tickets")
