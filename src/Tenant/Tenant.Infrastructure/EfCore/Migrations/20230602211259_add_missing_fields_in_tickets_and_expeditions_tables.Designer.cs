...
namespace Tenant.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20230602211259_add_missing_fields_in_tickets_and_expeditions_tables")]
    partial class add_missing_fields_in_tickets_and_expeditions_tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tenant.Domain.Ticket.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tenant.Domain.Ticket.Ticket", b =>
                {
                    b.HasOne("Tenant.Domain.Expedition.Expedition", null)
                        .WithMany("Tickets")
                        .HasForeignKey("ExpeditionId");

                    b.HasOne("Tenant.Domain.Passenger.Passenger", null)
                        .WithMany("Tickets")
                        .HasForeignKey("PassengerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Tenant.Domain.Ticket.TicketHistory", "History", b1 =>
                        {
                            ...
                            b1.ToTable("ticket_history", (string)null);
